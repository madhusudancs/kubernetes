...
// StoreToReplicaSetLister lists all ReplicaSets in the store.
// TODO: converge on the interface in pkg/client
...
// GetPodControllers returns a list of ReplicaSets managing a pod. Returns an error only if no matching ReplicaSets are found.
