...
func TestListReplicaSets(t *testing.T) {
	...
	receivedRSList, err := c.Setup(t).Extensions().ReplicaSets(ns).List(unversioned.ListOptions{})
...
func TestGetReplicaSet(t *testing.T) {
	...
	c := &testClient{
		Request: testRequest{Method: "GET", Path: testapi.Extensions.ResourcePath(getReplicaSetResourceName(), ns, "foo"), Query: buildQueryValues(nil)},
		Response: Response{
			StatusCode: 200,
...
func TestUpdateReplicaSet(t *testing.T) {
	...
	c := &testClient{
		Request: testRequest{Method: "PUT", Path: testapi.Extensions.ResourcePath(getReplicaSetResourceName(), ns, "foo"), Query: buildQueryValues(nil)},
		Response: Response{
			StatusCode: 200,
			Body: &extensions.ReplicaSet{
				ObjectMeta: api.ObjectMeta{
...
func TestUpdateStatusReplicaSet(t *testing.T) {
	...
	c := &testClient{
		Request: testRequest{Method: "PUT", Path: testapi.Extensions.ResourcePath(getReplicaSetResourceName(), ns, "foo") + "/status", Query: buildQueryValues(nil)},
		Response: Response{
			StatusCode: 200,
			Body: &extensions.ReplicaSet{
				ObjectMeta: api.ObjectMeta{
...
func TestDeleteReplicaSet(t *testing.T) {
	ns := api.NamespaceDefault
	c := &testClient{
		Request:  testRequest{Method: "DELETE", Path: testapi.Extensions.ResourcePath(getReplicaSetResourceName(), ns, "foo"), Query: buildQueryValues(nil)},
		Response: Response{StatusCode: 200},
	}
	err := c.Setup(t).Extensions().ReplicaSets(ns).Delete("foo")
...
func TestCreateReplicaSet(t *testing.T) {
	...
	c := &testClient{
		Request: testRequest{Method: "POST", Path: testapi.Extensions.ResourcePath(getReplicaSetResourceName(), ns, ""), Body: requestRS, Query: buildQueryValues(nil)},
		Response: Response{
			StatusCode: 200,
			Body: &extensions.ReplicaSet{
				ObjectMeta: api.ObjectMeta{
